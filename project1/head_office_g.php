...
<div class="charts-container">
    ...
    <div class="chart-container">
        <canvas id="engagementChart" width="840" height="320" style="display: block; box-sizing: border-box; height: 320px; width: 640px;"></canvas>
        </div>
        <div class="chart-container">
        <canvas id="usageChart" width="840" height="320" style="display: block; box-sizing: border-box; height: 320px; width: 640px;"></canvas>
        </div>
        <div class="chart-container">
        <canvas id="scatterChart" width="840" height="320" style="display: block; box-sizing: border-box; height: 320px; width: 640px;"></canvas>
        </div>
    </div>
