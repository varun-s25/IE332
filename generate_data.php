...
// Retrieve existing Order_ID values from the users table
...
// Insert data into the inventory_management table
...
echo "<script>setTimeout(function(){ window.location.href = 'login_design.php'; }, 10000);</script>"; // Redirect after 2 seconds
...
function generateServiceData() {
    ...
    foreach($existingMemberIDs as $MemberID) {
        for ($i = 0; $i < $rowCount; $i++) {
          ...
          $storeID = rand(0, 25); // Generate random store ID from 1 to 25
